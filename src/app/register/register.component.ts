...
export class RegisterComponent implements OnInit {
    ...
    formSubmit() {
      // registrujeme noveho pouzivatela
      //user: User = new User(name, this.stringify(this.registerForm.get('email')), id, date, this.registerForm.password, []);

      // po jeho vytvoreni sa moze prihlasit
      this.usersServerService.register().subscribe(
        ok => {
